...
// Create dummy users
await User.create({ username: 'elon.musk', displayName: 'Elon Musk', password: bcrypt.hashSync('imdabo$$', bcrypt.genSaltSync(salt))});
await User.create({ username: 'donald.trump', displayName: 'Donald Trump', password: bcrypt.hashSync('1234', bcrypt.genSaltSync(salt)) });
await User.create({ username: 'jane.doe', displayName: 'Jane Doe', password: bcrypt.hashSync('p@ssw0rd', bcrypt.genSaltSync(salt))});
